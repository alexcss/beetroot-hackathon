...
//remove users from api endpoints
...
function zg_yoast_to_bottom() {
	return 'low';
}

add_filter( 'wpseo_metabox_prio', 'zg_yoast_to_bottom' );
...
//function zg_filter_query( $query, $error = true ) {
//
...
//}
//
//add_action( 'parse_query', 'zg_filter_query' );
